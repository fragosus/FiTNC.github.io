...
function initMap(){
	...
	var CartoDB_DarkMatter = L.tileLayer('http://{s}.basemaps.cartocdn.com/dark_all/{z}/{x}/{y}.png', {	attribution: '&copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a> &copy; <a href="http://cartodb.com/attributions">CartoDB</a>',	subdomains: 'abcd',	maxZoom: 19	});
...
//------------------------------------------------------------------------------------------------------------------------------------
	...
	function Allwardsstyle(feature) {						
			return {
				fillColor: PopDensColor((feature.properties.TotDEPR)),
	...
	Totalpop = L.esri.featureLayer({ url: 'https://services7.arcgis.com/PlzZ51ukmuS0UkCo/arcgis/rest/services/Green_Depr_England_LSOA_and_Constituencies/FeatureServer/0/', style: totalwardsstyle, onEachFeature: poponEachFeature  });
...
//-------------------------------------------------------------------------------------------------------------------------------
	...
	//Basemaps are added
	var baseMaps = {"OpenStreetMap": openstreetmap, "DarkMatter": CartoDB_DarkMatter, "Bing map - Aerial": bing, "ESRI - Aerial": WorldImagery, "Esri WorldTopoMap": Esri_WorldTopoMap };
